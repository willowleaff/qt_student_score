...
// // NormalDistributionPlot::NormalDistributionPlot() {}
// #include "normaldistributionplot.h"
// #include <QPainter>
// #include <QPen>
// #include <QBrush>
...
//     // Y轴（频率/密度轴）
//     painter.drawLine(50, 50, 50, height()-50);
//     // 坐标轴标签
//     painter.drawText(width()-40, height()-30, "成绩");
//     painter.save();
//     painter.rotate(-90);
//     painter.drawText(-height()/2, 30, "频率/概率密度");
//     painter.restore();
...
//     painter.setBrush(QBrush(Qt::red, Qt::SolidPattern)); // 红色柱形
...
//         int w = scoreToX(binMax) - x - 1; // 柱形宽度
//         int h = (height() - 50) - y; // 柱形高度
//         painter.drawRect(x, y, w, h);
//     }

//     // 3. 绘制正态分布曲线（理论分布）
//     QPen curvePen(Qt::blue, 2); // 蓝色曲线
//     painter.setPen(curvePen);
//     painter.setBrush(Qt::NoBrush);

//     QVector<QPointF> points;
//     for (int i = 0; i <= 100; ++i) { // 100个点绘制曲线
...
//     // 4. 绘制均值线和标注
//     QPen meanPen(Qt::green, 1, Qt::DashLine); // 绿色虚线
//     painter.setPen(meanPen);
//     int meanX = scoreToX(m_mean);
//     painter.drawLine(meanX, 50, meanX, height()-50);
//     painter.drawText(meanX + 5, height()-60,
